...
export default function Trending({ articles, categories, seo, verificationMeta }: PageProps) {
    const page = usePage();
    ...
    return (
        <>
            {finalSeo ? <SeoHead seo={finalSeo} verification={finalVerification} /> : <Head title={`Trending - ${siteSettings.site_name}`} />}
            <AnalyticsScripts />
            <div className="min-h-screen bg-background">
                ...
                <div className="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
                    ...
                    <div className="mb-10 border-b border-border pb-8">
                        ...
                        <p className="mt-3 max-w-2xl text-base text-muted-foreground">Most viewed and talked about stories right now.</p>
                    </div>
                    <Deferred data="articles" fallback={
                        ...
                        {articles?.data && articles.data.length > 0 ? (
                            ...
                            <div className="py-20 text-center">
                                <p className="text-muted-foreground">No trending articles at the moment.</p>
